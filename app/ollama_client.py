...
def compose_character_prompt(image_path, style_name):
    ...
    prompt = (
        ...
        f"1. Turn the subject into this style: {style['style_prompt']} - while keeping "
        "their same rough pose and outfit recognizable.\n"
        "2. Replace the background with a NEW scene (in the same style) that suits the "
        ...
        "for what kind of new setting would fit.\n\n"
